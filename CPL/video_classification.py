...
# * When there are variations in between the frames of a video not all the
# frames might be equally important to decide its category. In those situations,
# putting a [self-attention layer](https://www.tensorflow.org/api_docs/python/tf/keras/layers/Attention) in the sequence model will
